  ...
  const profileLinks = (className: string) => (
    <div className={`shrink-0 items-center gap-1 ${className}`}>
      <a
        ...
        className="inline-flex h-7 min-w-7 items-center justify-center gap-1 rounded border border-border px-1.5 text-[11px] text-text-muted transition-colors hover:text-text"
      >
